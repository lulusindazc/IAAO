...
class ObjectgsDataset:

    def __init__(self, seq_name,obj_name) -> None:
        self.seq_name = seq_name
        self.obj_name= obj_name #'storage_example' 'refrigerator_example'
        ...
        self.segmentation_dir = f'{self.root}/sam_clip_features'
        self.object_dict_dir = f'{self.root}/mask'
        self.point_cloud_path =  f'{self.root}/iteration_3000/point_cloud.ply'  #f'{self.root}/scene_normalization.npz' #f'{self.root}/{seq_name}_vh_clean_2.ply' 
        self.mesh_path = self.point_cloud_path
        self.extrinsics_dir = f'{self.root}/pose' #f'{self.base_root}/init_keyframes.yml' ##f'{self.root}/pose'
    ...
    def get_intrinsics(self, frame_id):
        intrinsic_path = f'{self.root}/intrinsic.txt'
