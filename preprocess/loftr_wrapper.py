...
from third_parties.LoFTR.src.loftr import default_cfg, LoFTR

state_dict_path = '/workspace/pretrains/foundation_models/indoor_ds_new.ckpt' #pjoin(base_dir, '../third_parties/LoFTR/weights/outdoor_ds.ckpt')
